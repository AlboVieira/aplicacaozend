...
class PedidoService extends ServiceAbstract
{
    ...
    public function salvar(Pedido $pedido, $isEdit)
    {
        /** @var PedidoDao $dao */
    ...
    public function getGridItemPedido()
    {
        $jqgrid = new JqGridTable();
        $jqgrid->addColunas(array(JqGridConst::LABEL =>
        ...
        $jqgrid->addColunas(array(JqGridConst::LABEL =>
            ItemPedidoConst::LBL_PEDIDO, JqGridConst::NAME => ItemPedidoConst::FLD_PEDIDO, JqGridConst::WIDTH => 80));
